...
import sys
sys.path.append('/home/qii/dy/RankEncoder-main/code/SimCSE_RankEncoder/sentence_transformers_ext/')
...
#     "home/qii/dy/RankEncoder-main/code/SimCSE_RankEncoder/SentEval/outputs/simcse/checkpoints/simcse_unsup_rank_encoder_seed_61507": "bert-base-uncased",
#    "home/qii/dy/RankEncoder-main/code/SimCSE_RankEncoder/SentEval/outputs/simcse/checkpoints/simcse_unsup_rank_encoder_seed_large_61507": "bert-large-uncased"}
...
pooling_model = models.Pooling(word_embedding_model.get_word_embedding_dimension(),
                               pooling_mode=args.bi_encoder_pooling_mode)
...
for cycle in range(total_cycle):
    ...
    if args.init_with_new_models:
        bi_encoder_path ="bert-large-uncased"
...
if args.save_all_predictions:
    bi_pred_df = pd.DataFrame(np.array(list(all_predictions_bi_encoder.values())).T,
                              columns=list(all_predictions_bi_encoder.keys()))
    cross_pred_df = pd.DataFrame(np.array(list(all_predictions_cross_encoder.values())).T,
                                 columns=list(all_predictions_cross_encoder.keys()))
