...
class CECorrelationEvaluatorEnsemble:
    """
    ...
    def __call__(self, models, output_path: str = None, epoch: int = -1, steps: int = -1) -> float:
        ...
        if output_path is not None and self.write_csv:
            things_to_write = [epoch, steps, eval_pearson, eval_spearman]
            write_csv_log(output_path=output_path, csv_file=self.csv_file, csv_headers=self.csv_headers,
